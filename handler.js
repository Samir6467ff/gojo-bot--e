...
export async function deleteUpdate(message) {
  ...
  let time = d.toLocaleString('ar', { hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true })
  try {
